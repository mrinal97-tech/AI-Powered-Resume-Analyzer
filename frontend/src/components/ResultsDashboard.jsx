  ...
  return (
    <div className="flex flex-col items-center">
      <svg width="140" height="140" viewBox="0 0 140 140">
        ...
        <text x="70" y="70" textAnchor="middle"
      ...
      <div>
        ...
        <div className="flex flex-wrap gap-2">
          {data.skills_found.map(s => (
            <span key={s} className="bg-green-100 text-green-800
                                     px-2 py-1 rounded text-xs">{s}</span>
          ))}
        </div>
      </div>
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-2">
            {data.missing_skills.map(s => (
              <span key={s} className="bg-red-100 text-red-800
                                       px-2 py-1 rounded text-xs">{s}</span>
            ))}
          </div>
        </div>
